...
// Tentukan tanggal dan waktu yang diinginkan
$tanggalDanWaktu = date("Y-m-d H:i:s");

// Kueri SQL hanya mengambil transaksi yang sesuai dengan tanggal dan waktu tertentu
$query = "SELECT * FROM detailpenjualan";
$result = mysqli_query($koneksi, $query);

// Cetak hasil transaksi
while ($row = mysqli_fetch_assoc($result)) {
    // Proses pencetakan informasi transaksi
    // ...
}
?>
            ...
            <tr>
                <td width='70%' align='center' vertical-align='top'>
                    <span style='color:black;'>
                        <b>KASIR HAFIDH</b></br>Jl.Gemolong, Sragen
                    </span><br>
                    <br>
                </td>
            </tr>
